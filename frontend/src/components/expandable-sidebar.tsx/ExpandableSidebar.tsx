  ...
  return (
    <div
      className={clsx(
        ...
        "fixed top-0 right-0 bottom-0 left-0 z-40 flex h-screen flex-col items-center justify-between overflow-hidden border-gray-200 bg-white lg:border-r lg:opacity-100 dark:border-gray-900 dark:bg-gray-950",
      )}
      style={{
        transition:
